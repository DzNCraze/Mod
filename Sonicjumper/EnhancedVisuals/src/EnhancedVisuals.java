...
public class EnhancedVisuals {
	public final static String ID = "EnhancedVisuals";
	public final static String NAME = "Enhanced Visuals";
	public final static String VERSION = "1.0.0";

	@Instance("EnhancedVisuals")
    ...
    @SidedProxy(clientSide="Sonicjumper.EnhancedVisuals.src.ClientProxy", serverSide="Sonicjumper.EnhancedVisuals.src.ServerProxy")
    public static ServerProxy proxy;
    
    @EventHandler
    public void preInit(FMLPreInitializationEvent event) {
    	ModMetadata myMeta = event.getModMetadata();
		myMeta.authorList = Arrays.asList(new String[] { "MstqL", "Funwayguy" });
		myMeta.autogenerated = false;
		myMeta.description = "Want some amazing screen modifactions this is the mod for you !! ";
		myMeta.url = "http://tinyurl.com/px9pzfg";
